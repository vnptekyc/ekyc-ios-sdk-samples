...
SWIFT_PROTOCOL("_TtP8FinalSDK15SDKRootDelegate_")
@protocol SDKRootDelegate
- (void)getResult;
@end


SWIFT_CLASS("_TtC8FinalSDK13SDKRootRouter")
@interface SDKRootRouter : NSObject
+ (UIViewController * _Nonnull)createModule SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface SDKRootViewController : UIViewController <CameraDelegate>
@property (nonatomic, weak) id <SDKRootDelegate> _Nullable sdkRootDelegate;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewDidAppear:(BOOL)animated;
